...
var SectionRoot = function SectionRoot(_ref) {
  ...
  var _useState3 = React.useState(window.pageYOffset || window.scrollY),
  ...
  var detectScrollDirection = React.useCallback(function (e) {
  ...
  var setScreenNotScrollableDuringScrollThrottle = React.useCallback(function () {
    setScrollable(false);
    setTimeout(function () {
      setScrollable(true);
    }, 1200);
